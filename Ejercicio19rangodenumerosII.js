...
Si el primer número es menor que el segundo imprime los números en el rango 
de forma ascendente. Por ejemplo, si el usuario ingresa 5 como primer número y 10 
...
9
10
Si el primer número es mayor que el segundo imprime los números en el rango de 
forma descendente. Por ejemplo, si el usuario ingresa 10 como primer número y 5 como 
