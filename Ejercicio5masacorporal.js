...
Escribe un programa que le pida al usuario su peso y su altura para calcular su BMI e 
imprima la frase "Tu BMI es X".
Por ejemplo, si el usuario ingresa 65 de peso y 1.8 de altura el programa debe imprimir 
en la consola la frase "Tu BMI es 20.061728395061728".*/

let peso = parseFloat(prompt("Escribe tu peso"));
let altura = parseFloat(prompt("Escribe tu altura"));
let resultado = peso / altura ** 2;

console.log(`Tu BMI es ${resultado.toFixed(2)}`);
